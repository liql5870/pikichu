...
})({"3O8ak":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const player = {
    ...
    run: ()=>{
        player.n += 1;
        if (player.n > _cssJsDefault.default.length) window.clearInterval(player.id);
        player.ui.demo.innerText = _cssJsDefault.default.substr(0, player.n);
        player.ui.demo2.innerHTML = _cssJsDefault.default.substr(0, player.n);
...
},{"./css.js":"apd2l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"apd2l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["3O8ak","lxd7M"], "lxd7M", "parcelRequire94c2")
